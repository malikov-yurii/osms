...
public class OrderTestData {
    ...
    public static final Order ORDER_1 = new Order(1, CUSTOMER_GOLOV, ADMIN, POTAL_NAZIONALE, FERRARIO_ROZOVYJ);
    public static final Order ORDER_2 = new Order(2, CUSTOMER_GOLOV, ADMIN, SHELLAC_MANETTI, POTAL_KITAJ);
    public static final Order ORDER_3 = new Order(3, CUSTOMER_DROGOV, ADMIN, POTAL_KITAJ);
    public static final Order ORDER_4 = new Order(4, CUSTOMER_DUNOV, ADMIN, POTAL_NAZIONALE, FERRARIO_ROZOVYJ, SHELLAC_MANETTI);
