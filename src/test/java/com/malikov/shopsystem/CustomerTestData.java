...
public class CustomerTestData {
    public static final Customer CUSTOMER_DROGOV = new Customer(
            1L, "Alex", "Drogichinskij", "0674861352", "Ilichevsk", "3", "drogychynsky@gmail.com", "");
    public static final Customer CUSTOMER_GOLOV = new Customer(
            2L, "Sergei", "Goltvjanskij", "0938754590", "Kiev", "31", "goltvyanskyy@gmail.com", "");
    public static final Customer CUSTOMER_DUNOV      = new Customer(
            3L, "Elena", "Dunovskaya", "0984231204", "Sumy", "7", "katerina.tcherednichenko@yandex.ru", "");
    public static final Customer CUSTOMER_WITHOUT_ANY_ORDER      = new Customer(
            4L, "WithNoOrderName", "WithNoOrderLastName", "0980000000", "ZeroTown", "0", "zero@yandex.ru", "");
