        ...
        animations: [
            animations_1.trigger('fadeInOut', [
                ...
                animations_1.transition('* => destroying', [
                    animations_1.animate('0.2s ease', animations_1.style({ opacity: 0 }))
                ])
            ]),
            animations_1.trigger('flyInOut', [
                animations_1.transition(':enter', [
                    animations_1.style({ opacity: 0, transform: 'translate(-90%, -50%)' }),
                    animations_1.animate('0.2s ease', animations_1.style({ opacity: 1, transform: 'translate(-50%, -50%)' }))
                ]),
                animations_1.transition('* => destroying', [
                    animations_1.animate('0.2s ease', animations_1.style({ opacity: 0, transform: 'translate(-10%, -50%)' }))
                ])
            ]),
