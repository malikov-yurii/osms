...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getAllProducts = function () {
        ...
        return this.api.get(this.productsPath + "?pageNumber=0&pageCapacity=10000")
            ...
            content.sort(function (a, b) { return a.productId - b.productId; });
            content = content.map(function (el) {
                el.productCategories = el.productCategories.join('; ');
                return el;
            });
            _this.storeHelper.update(_this.productsPath, content);
    ...
    ProductService.prototype.list = function (searchQuery, page, length, filterData) {
        var searchResult = this.searchService.search(this.storeHelper.get(this.productsPath), searchQuery, ['productName', 'productPrice']);
